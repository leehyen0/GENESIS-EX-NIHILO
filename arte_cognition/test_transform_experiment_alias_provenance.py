...
class TransformExperimentAliasProvenanceTests(unittest.TestCase):
    def test_same_exact_intervention_unions_transform_program_ancestry(self):
        base = InterventionProposal(
            ...
            reason=(
                "cross learned latent projection threshold; probe_scale=13716.379729753171 "
        ...
        alias = replace(
            base,
            reason=(
                "cross learned latent projection threshold; probe_scale=13716.379729753173 "
    ...
    def test_same_id_with_different_exact_action_does_not_merge_ancestry(self):
