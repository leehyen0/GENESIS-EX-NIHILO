...
def main() -> None:
    ...
    artifact = {
        ...
        "role_map": {
            "github_actions_audited_semantic": ["execution_availability"],
            "vercel_deployment": ["execution", "semantic_validity", "authority_boundary"]
        },
        "forbidden_inference_used": True,
        "claim_boundary": {
            "AGI": False,
            "ASI": False,
