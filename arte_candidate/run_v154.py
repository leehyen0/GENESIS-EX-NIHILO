...
def main():
    ...
    artifact={
      ...
      'authority_vector':{'EXECUTION_AVAILABILITY':False,'SEMANTIC_CORRECTNESS':True,'FRESHNESS':True,'INDEPENDENCE_FIREWALL':True,'CLAIM_BOUNDARY':True},
      'axis_providers':{'SEMANTIC_CORRECTNESS':'github_actions_audited','FRESHNESS':'github_actions_audited','INDEPENDENCE_FIREWALL':'github_actions_audited','CLAIM_BOUNDARY':'github_actions_audited'},
      'provider_role_collapse':False,'source_dropout':True,'stale_epoch_mix':False,'forbidden_inferences_used':False,'candidate_can_modify_authority_product':False,
      'claim_boundary':{'AGI':False,'ASI':False,'independent_organization_custody':False,'recursive_acceleration_proven':False}}
    out=Path(a.output);out.parent.mkdir(parents=True,exist_ok=True);out.write_text(json.dumps(artifact,indent=2)+'\n');print('V154_SOURCE_DROPOUT_WRITTEN')
