...
def main():
    ...
    artifact={
      ...
      'selected_parent':'ROLE_COLLAPSE',
      'rejected_candidates':['GOOD','SOURCE_DROPOUT','EPOCH_MIX'],
      'cognition_update':'PROVIDER_CONSENSUS_OVERRIDES_TYPED_AUTHORITY',
      'deployment_only_can_rescue_semantic_failure':True,
